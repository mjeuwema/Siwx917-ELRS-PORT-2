...
static inline int read_busy_pin(void) {
  ...
  return (int)(EGPIO_BIT_LOAD_REG(LR1121_PIN_BUSY) & 1U);
#else
#if SIW917_ELRS_BUSY_PORT_READ
...
#if SIW917_ELRS_FAST_GSPI_CACHE_PIN_REGS
  volatile uint32_t *const busy_reg = &EGPIO_BIT_LOAD_REG(LR1121_PIN_BUSY);
...
#if SIW917_ELRS_FAST_GSPI_CACHE_PIN_REGS
  volatile uint32_t *const nss_reg = &EGPIO_BIT_LOAD_REG(LR1121_PIN_NSS);
  *nss_reg = 0U;
#else
#if SIW917_ELRS_FAST_GSPI_CACHE_PIN_REGS
  volatile uint32_t *const nss_reg = &EGPIO_BIT_LOAD_REG(LR1121_PIN_NSS);
 ...
 * but the PHYSICAL wire must connect LR1121 DIO9 to SiWx917 GPIO_12.
 *
 * HARDWARE WIRING: Connect LR1121 DIO9 to GPIO_12 on the SiWx917-DK2605A.
 *
...
/* DIO9 pin configuration - GPIO_12 (HP domain, DK2605A breakout accessible)
 ...
 *
 * GPIO_12 is on Port A (0-15), pin number within port = 12
 */
#define DIO1_HP_GPIO LR1121_PIN_IRQ /* SiWx917 GPIO connected to LR1121 DIO9 */
#if (DIO1_HP_GPIO < 16)
#define DIO1_HP_PORT SL_GPIO_PORT_A
#define DIO1_HP_PIN DIO1_HP_GPIO
#elif (DIO1_HP_GPIO < 32)
#define DIO1_HP_PORT SL_GPIO_PORT_B
#define DIO1_HP_PIN (DIO1_HP_GPIO - 16)
#elif (DIO1_HP_GPIO < 48)
#define DIO1_HP_PORT SL_GPIO_PORT_C
#define DIO1_HP_PIN (DIO1_HP_GPIO - 32)
#else
#define DIO1_HP_PORT SL_GPIO_PORT_D
#define DIO1_HP_PIN (DIO1_HP_GPIO - 48)
#endif
 ...
 *
 * Uses the configured breakout GPIO with HP GPIO pin interrupt channel 2.
 *

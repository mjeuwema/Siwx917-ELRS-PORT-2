...
/*
 * High-rate safety margin trims from the working RX timing branch. These
 * counters/timestamps were useful while bringing up DIO and CRC timing, but
 * every volatile write and timestamp read steals budget from the radio slot.
 */
 ...
 * command params directly instead of staging through a temporary tx array.
 */

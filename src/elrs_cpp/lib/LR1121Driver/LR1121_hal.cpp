// Skip this file on SiW917 - use src/elrs_cpp/hal/LR1121_hal.cpp instead
// which properly configures UULP GPIO interrupts via lr1121_dio1_*() functions
#if defined(UNIT_TEST) || defined(PLATFORM_SIW917)
// Empty - SiW917 uses custom HAL in src/elrs_cpp/hal/LR1121_hal.cpp
#else
...
#endif // !UNIT_TEST && !PLATFORM_SIW917

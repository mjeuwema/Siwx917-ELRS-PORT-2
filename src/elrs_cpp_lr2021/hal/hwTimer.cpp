...
void hwTimer::resume(bool deliverImmediateTock) {
  if (running)
    return;
  ...
  DBGLN("hwTimer resumed, interval=%lu us imm=%u", HWtimerInterval,
        deliverImmediateTock ? 1U : 0U);
}

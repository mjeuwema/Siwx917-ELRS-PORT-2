...
elseif(WIN32)
  set(POST_BUILD_EXE "C:/Users/mjeuw/.silabs/slt/installs/archive/Simplicity Commander/commander.exe")
elseif(APPLE)
  set(POST_BUILD_EXE "")
else()
  set(POST_BUILD_EXE "")
...
elseif(WIN32)
  set(NINJA_RUNTIME_PATH "C:/Users/mjeuw/.silabs/slt/installs/conan/p/ninja1a38fc85adcf7/p/ninja.exe")
elseif(APPLE)

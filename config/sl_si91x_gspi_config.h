...
//  <i> Default: 1
//  NOTE: Set to 0 to allow LR1121 driver to configure GSPI for software CS control
#define GSPI_UC 0
...
// <i> Default: 10000000
#define SL_GSPI_BITRATE 1000000  /* 1 MHz */
...
sl_gspi_control_config_t gspi_configuration = {
  ...
  .slave_select_mode = SL_GSPI_MASTER_HW_OUTPUT,  /* SDK default - we do manual CS separately */

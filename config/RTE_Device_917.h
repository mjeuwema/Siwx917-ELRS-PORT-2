...
#define RTE_UART1_DMA_MODE1_EN 1
...
/*
 * Legacy direct single-wire SiW UART mode. The current handset-module adapter
 * topology keeps SiW UART1 as normal TX/RX pins and lets the external
 * inverter/tri-state board combine the radio-side DATA line, so this override
 * is disabled unless a build explicitly opts back into direct single-wire mode.
 */
#undef RTE_UART1_RX_PORT
#undef RTE_UART1_RX_PIN
#undef RTE_UART1_RX_MUX
#undef RTE_UART1_RX_PAD
#define RTE_UART1_RX_PORT RTE_UART1_TX_PORT
#define RTE_UART1_RX_PIN  RTE_UART1_TX_PIN
#define RTE_UART1_RX_MUX  RTE_UART1_TX_MUX
#define RTE_UART1_RX_PAD  RTE_UART1_TX_PAD
#endif
